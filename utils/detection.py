    ...
    if keras is None:
        try:
            ...
            try:
                ...
                print(f"❌ Could not import keras: {e}, {e2}")
...
class DeepFakeDetector:
    ...
    def __init__(self, model_path=None, threshold=0.5, target_size=(128, 128)):
        ...
        if model_path:
            ...
            print("ℹ️  No model specified - cannot perform detection")
        ...
        try:
            ...
            try:
                ...
                if ('batch_shape' in error_msg or 'deserializing class' in error_msg or 
                    ...
                    print(f"⚠️ Keras compatibility issue detected: {error_msg[:100]}...")
                    ...
                    print(f"❌ Error loading model: {str(load_error)[:100]}...")
                    self.model = None
    ...
    def _reconstruct_image_model(self, model_path):
        ...
        try:
            ...
            print(f"🏗️ Reconstructing image model architecture...")
            ...
            try:
                ...
                print(f"⚠️ Weight loading failed: {str(we)}")
            ...
            print(f"❌ Model reconstruction failed: {str(e)}")
            return None
    ...
    def _reconstruct_video_model(self, model_path):
        ...
        try:
            ...
            print(f"🏗️ Reconstructing video model architecture...")
            ...
            print(f"❌ Video model reconstruction failed: {str(e)}")
            return None
